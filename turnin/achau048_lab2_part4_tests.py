...
tests = [ {'description': 'PINA: 0x00, PINB: 0x00, PINC: 0x00 => PORTD: 0x00 (No Weight)',
	...
	{'description': 'PINA: 0x1E, PINB: 0x00, PINC: 0x0A => PORTD: 0x18 (Empty SeatB)',
	'steps': [ {'inputs': [('PINA',0x1E),('PINB',0x00),('PINC',0x0A)], 'iterations': 5 } ],
	'expected': [('PORTD',0x18)],
	},
	{'description': 'PINA: 0x00, PINB: 0x09, PINC: 0x20 => PORTD: 0x18 (Empty SeatA)',
	'steps': [ {'inputs': [('PINA',0x00),('PINB',0x09),('PINC',0x20)], 'iterations': 5 } ],
	'expected': [('PORTD',0x18)],
	},
	{'description': 'PINA: 0x1E, PINB: 0x10, PINC: 0x21 => PORTD: 0x18 (All Three Seats Occupied)',
	'steps': [ {'inputs': [('PINA',0x1E),('PINB',0x10),('PINC',0x21)], 'iterations': 5 } ],
	'expected': [('PORTD',0x18)],
	},
	{'description': 'PINA: 0x32, PINB: 0x28, PINC: 0x32 => PORTD: 0x38 (Weight Adds Up To 140kg)',
	...
	{'description': 'PINA: 0x00, PINB: 0xFF, PINC: 0x00 => PORTD: 0xBD (Only SeatB Full Weight)',
	'steps': [ {'inputs': [('PINA',0x00),('PINB',0xFF),('PINC',0x00)], 'iterations': 5 } ],
	'expected': [('PORTD',0xBD)],
	},
	{'description': 'PINA: 0x51, PINB: 0x00, PINC: 0x00 => PORTD: 0xBE (Unbalanced Heavy SeatA)',
	'steps': [ {'inputs': [('PINA',0x51),('PINB',0x00),('PINC',0x00)], 'iterations': 5 } ],
	'expected': [('PORTD',0xBE)],
	},
	{'description': 'PINA: 0x00, PINB: 0xFF, PINC: 0x51 => PORTD: 0xBE (Unbalanced Heavy SeatC)',
	'steps': [ {'inputs': [('PINA',0x00),('PINB',0x00),('PINC',0x51)], 'iterations': 5 } ],
	'expected': [('PORTD',0xBE)],
	},
	{'description': 'PINA: 0xFF, PINB: 0x00, PINC: 0x00 => PORTD: 0xBF (Only SeatA Full Weight)',
	'steps': [ {'inputs': [('PINA',0xFF),('PINB',0x00),('PINC',0x00)], 'iterations': 5 } ],
	'expected': [('PORTD',0xBF)],
	},
	{'description': 'PINA: 0x00, PINB: 0x00, PINC: 0xFF => PORTD: 0xBF (Only SeatC Full Weight)',
